...
@group(0) @binding(3) var<uniform> particle_radius: f32;
...
fn apply_velocity_and_collide(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let half_bounds_width = bounds_size.x / 2.0 - particle_radius;
    let half_bounds_height = bounds_size.y / 2.0 - particle_radius;
